...
const testsDatabase = {
    ...
    C1: [
        ...
        { code: 'CAE002', file: 'CAE002.html', status: 'Coming Soon' },
        { code: 'CAE003', file: 'CAE003.html', status: 'Coming Soon' },
        { code: 'CAE004', file: 'CAE004.html', status: 'Coming Soon' }
    ]
};
